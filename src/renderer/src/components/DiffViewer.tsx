    ...
    <div className="flex h-full flex-col bg-[#1e1e1e]">
      <div className="flex items-center gap-2 border-b border-[#3e3e42] bg-[#252526] px-3 py-2">
        ...
        <div className="flex items-center gap-1">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button onClick={() => navigateDiff("prev")} aria-label={t("diff.prevAriaLabel")}>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button onClick={() => navigateDiff("next")} aria-label={t("diff.nextAriaLabel")}>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button onClick={openFind} aria-label={t("diff.findAriaLabel")}>
